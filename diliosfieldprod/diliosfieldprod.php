...
class Diliosfieldprod extends Module {
    ...
    public function hookActionAdminProductsControllerSaveBefore($params) {
        ...
        foreach($keys as $key){
            ...
            foreach(Language::getLanguages() as $language){
                $data_title =  $_REQUEST['form'][$title_field];
                $data_description = $_REQUEST['form'][$description_field];
                
                $data['title'][$key] = [
                    'id_product' => $product->id,
                    'key' => $title_field,
                    'id_lang' => $language['id_lang'],
                    'value' => $data_title[$language['id_lang']],
                ];
                ...
                $data['description'][$key] = [
                    ...
                    'key' => $title_field,
                    'id_lang' => $language['id_lang'],
                    'value' => $data_description[$language['id_lang']]
                ];
            }
        }
    ...
    public function getForm($id_product, $title, $key = "dfc") {
        ...
        $formBuilder->add($title_field, TranslatableType::class, [
            'type' => TextType::class,
